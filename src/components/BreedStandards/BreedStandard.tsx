    ...
    try {
      ...
      switch (generation) {
        case "PARENT":
          ...
          const postP = await postParentStandard(formData.breedId, payloadP);
          if (postP.status == 201) {
        ...
        case "GRANDPARENT":
          ...
          const postGP = await postGrandParentStandard(
            formData.breedId,
            payloadGP,
          );
          if (postGP.status == 201) {
            toast.success("Data Submitted Successfully");
          }
          setBreeders([]);
          break;
        ...
        case "BROILER":
          ...
          const postB = await postBroilers(formData.breedId, broilerPayload);
        ...
        case "LAYER":
          ...
          const postL = await postLayers(formData.breedId, layerPayload);
