import {
  getAverageStandard,
  getChartData,
} from "@/app/(Protected_Routes)/(sub_protected_routes)/dashboard/calculation/action";
import {
  CalcFormData,
  CalcParamFormDataType,
  initialCalcParamFormData,
  initialStatePoultryData,
  ProductionDataMap,
  StandardPoultryData,
    ...
    try {
      ...
      const newData: StandardPoultryData = {
        grandParent: {
          ...
          averageParameter: {
            averageHatchableEggRate: formatToInteger(
              api.grandParent.averageParameter.averageHatchableEggRate,
            ),
            averageCumulativeMortalityRate: formatToInteger(
              api.grandParent.averageParameter.cumulativeMortalityRate,
            ),
            averageHatchingEggRate: formatToInteger(
              api.grandParent.averageParameter.averageHatchingEggRate,
            ),
          },
        },
        parent: {
          ...
          averageParameter: {
            averageHatchableEggRate: formatToInteger(
              api.parent.averageParameter.averageHatchableEggRate,
            ),
            averageCumulativeMortalityRate: formatToInteger(
              api.parent.averageParameter.cumulativeMortalityRate,
            ),
            averageHatchingEggRate: formatToInteger(
              api.parent.averageParameter.averageHatchingEggRate,
            ),
          },
        },
        layer: {
          ...
          averageParameter: {
            eggProductionRate: formatToInteger(
              api.layer.averageParameter.eggProductionRate,
            ),
            cumulativeMortalityRate: formatToInteger(
              api.layer.averageParameter.cumulativeMortalityRate,
            ),
            damagedEggRate: formatToInteger(
              api.layer.averageParameter.damagedEggRate,
            ),
          },
        },
        broiler: {
          ...
          averageParameter: {
            ...
            cumulativeMortalityRate: formatToInteger(
              api.broiler.averageParameter.cumulativeMortalityRate,
            ),
          },
        },
      };
